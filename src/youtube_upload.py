...
'''
# For right now, we are using youtube-upload by Arnou Sanchez as the
# base for the youtube upload code.  However this will be removed due
# to the licensing restrictions it places on this.
#
# Do NOT mistake this to mean I intend to close the source for any
# reason, I am just not a particular fan of the GPLv3
'''
